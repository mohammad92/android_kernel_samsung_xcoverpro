...
static ssize_t camera_tilt_show(char *buf, int position)
{
	...
	if (specific->rom_cal_map_addr[rom_position]->rom_dual_cal_data2_size > 0) {
		...
		int32_t dual_tilt_dll_modelID = specific->rom_cal_map_addr[rom_position]->rom_dual_tilt_dll_modelID_addr;
		int32_t dual_tilt_dll_modelIDLength = specific->rom_cal_map_addr[rom_position]->rom_dual_tilt_dll_modelID_size;
